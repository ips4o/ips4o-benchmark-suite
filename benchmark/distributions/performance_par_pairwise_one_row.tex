...
%      xlabel={Running time ratio relative to best $-$ $1$},
      ...
      % Add (a), (b), ... to subtitles
      % subtitle/.style={title=\gpsubtitle{#1}}
      %subtitle/.style={title=\gpsubtitle{#1}}
       subtitle/.style={title=#1},
      ytick = {0, 0.25, 0.5, 0.75, 1},%<- keine Extraticks nötig
      xtick = {0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2},%<- keine Extraticks nötig
      xticklabels = {0, , 0.25, , 1, , 2.25, , 4},
      ]
      
      \nextgroupplot[
      % subtitle={Unsigned Integer Keys},
    ...
    % (Relative) Coordinate at top of the first plot
      ...
      \nextgroupplot[
%      subtitle={\SLabel{fig: sub seq perf comp} All Data Types},
  ...
  \caption{Pairwise performance profiles of \compiparassssort to
    ...
    \distreversesorted, and \distones. The x-axis uses a square-root-scale to emphasize small running time ratios.}\label{fig:perf par}
\end{figure}
