...
avgfast <- avgfast %>% filter(!(algo  %in% c('ips4oml','learnedsort','aspas','quickxsort','wikisort','ssss','yaroslavskiy','openjdkyaroslavskiy','ps4o','ips2ra','blockquicksort','ippradixsort')))
...
tb_name = "perfseq"
performance1 = performance1 %>% add_row(algo = 'ippradixsort', n = -1, ratio = 4)
performance1 = performance1 %>% add_row(algo = 'ips2ra', n = -1, ratio = 4)
performance1 = performance1 %>% add_row(algo = 'skasort', n = -1, ratio = 4)
