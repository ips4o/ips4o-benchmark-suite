...
tb_name = "perfpar"
performance1 = performance1 %>% add_row(algo = 'ips2raparallel', n = -1, ratio = 4)
performance1 = performance1 %>% add_row(algo = 'pbbsradixsort', n = -1, ratio = 4)
performance1 = performance1 %>% add_row(algo = 'raduls', n = -1, ratio = 4)
performance1 = performance1 %>% add_row(algo = 'regionsort', n = -1, ratio = 4)
