 ...
 *
 * src/benchmark/benchmark_ips4ooldparallel.cpp
 *
 * Parallel ips4o benchmark.
 *
...
#include "../algorithm/ips4ooldparallel.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, omp::Ips4ooldparallel>;
