 ...
 *
 * src/benchmark/benchmark_ips2ra.cpp
 *
 * Sequential radix sort integrated into the ips4o framework benchmark.
 *
...
#include "../algorithm/ips2ra.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, sequential::Ips3ro>;
