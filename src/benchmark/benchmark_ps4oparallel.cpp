 ...
 *
 * src/benchmark/benchmark_ps4oparallel.cpp
 *
 * Parallel Super-Scalar-Sample-Sort benchmark.
 *
...
#include "../algorithm/ps4oparallel.hpp"
#include "../benchmark.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, omp::Ps4oparallel>;
