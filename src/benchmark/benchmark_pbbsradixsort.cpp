 ...
 *
 * src/benchmark/benchmark_pbbsradixsort.cpp
 *
 * Parallel radix sort form the PBBS benchmark suite benchmark.
 *
...
#include "../algorithm/pbbsradixsort.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, cilk_algos::PbbsRadixsort>;
