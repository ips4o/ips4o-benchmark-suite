 ...
 *
 * src/benchmark/benchmark_gnuquicksortunbalanced.cpp
 *
...
#include "../algorithm/gnuquicksortunbalanced.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, omp::GnuQuicksortUnbalanced>;
