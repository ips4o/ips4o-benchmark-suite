 ...
 *
 * src/benchmark/benchmark_ssss.cpp
 *
 * Super-Scalar-SampleSort from L. H. Schneider benchmark.
 *
...
#include "../algorithm/ssss.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, sequential::Ssss>;
