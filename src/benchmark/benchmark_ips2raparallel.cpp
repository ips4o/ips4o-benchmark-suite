 ...
 *
 * src/benchmark/benchmark_ips2raparallel.cpp
 *
 * Parallel radix sort integrated into the ips4o framework benchmark.
 *
...
#include "../algorithm/ips2raparallel.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, omp::Ips3roParallel>;
