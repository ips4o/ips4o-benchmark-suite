 ...
 *
 * src/benchmark/benchmark_inplacemsdradixsort.cpp
 *
 * Parallel inplace radixsort benchmark.
 *
...
#include "../algorithm/inplace_msd_radixsort.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, pthread::Inplacemsdradixsort>;
