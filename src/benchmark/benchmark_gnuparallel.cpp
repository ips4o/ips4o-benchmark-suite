 ...
 *
 * src/benchmark/benchmark_gnuparallel.cpp
 *
 * Parallel mergesort algorithm the GNU Compiler Collection benchmark.
 *
...
#include "../algorithm/gnuparallel.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, omp::GnuParallel>;
