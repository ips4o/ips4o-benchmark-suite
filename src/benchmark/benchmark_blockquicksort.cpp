 ...
 *
 * src/benchmark/benchmark_blockquicksort.cpp
 *
 * Blockquicksort benchmark.
 *
...
#include "../algorithm/blockquicksort.hpp"
#include "../benchmark.hpp"
#include "../name_extractor.hpp"

using Algorithm = Sequence<true, sequential::BlockQuicksort>;
