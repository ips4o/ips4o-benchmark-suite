 ...
 *
 * src/algorithm/blockquicksort.hpp
 *
 * Algorithm blockquicksort.
 *
...
#include "../../extern/BlockQuicksort/blocked_double_pivot_check_mosqrt.h++"
...
class BlockQuicksort {
 public:
    ...
    static std::string name() { return "blockquicksort"; }
    ...
    static std::pair<double, double> sort(T* begin, T* end, size_t num_threads) {
        ...
        blocked_double_pivot_check_mosqrt::sort(begin, end, Datatype<T>::getComparator());
