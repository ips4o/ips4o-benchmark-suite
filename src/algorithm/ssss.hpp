 ...
 *
 * src/algorithm/ssss.hpp
 *
 * Super-Scalar-SampleSort from L. H. Schneider.
 *
...
#include "../../extern/ssssort/ssssort.h"
...
class Ssss {
 public:
    ...
    static std::string name() { return "ssss"; }
    ...
    static std::pair<double, double> sort(T* begin, T* end, size_t num_threads) {
        ...
        ssssort::ssssort(begin, end, Datatype<T>::getComparator());
