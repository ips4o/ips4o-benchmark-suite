...
#include "../../extern/cpp-TimSort/include/gfx/timsort.hpp"
...
class Timsort {
 public:
    ...
    static std::string name() { return "timsort"; }
    ...
    static std::pair<double, double> sort(T* begin, T* end, size_t num_threads) {
        ...
        gfx::timsort(begin, end, Datatype<T>::getComparator());
